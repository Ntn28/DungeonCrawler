...
enum PACKET_TYPE {JOIN, WELCOME, MELEE, MOVEMENT, LAST};
...
int send_packet(const int s, const unsigned int packet_type, const unsigned int p_id, const float x, const float y, const unsigned int order, struct sockaddr_in *sin);
